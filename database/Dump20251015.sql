...
CREATE TABLE `invoices` (
  ...
  `period_start` varchar(200) DEFAULT NULL,
  `period_end` varchar(200) DEFAULT NULL,
  `total_amount` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `ix_invoices_id` (`id`),
  KEY `ix_invoices_period_end` (`period_end`),
  KEY `ix_invoices_client_name` (`client_name`),
  KEY `ix_invoices_period_start` (`period_start`),
  KEY `ix_invoices_project_id` (`project_id`)
...
CREATE TABLE `users` (
  ...
  KEY `ix_users_id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7597256 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (3497285,'danielavivan@gmail.com','Daniela Vivan','contributor'),(6013857,'pedrogaldfreitas@gmail.com','Pedro Freitas','manager'),(6482591,'joaovivanf@gmail.com','Joao Freitas','contributor'),(7597254,'paulogfreitas@gmail.com','Paulo Freitas','contributor'),(7597255,'alice@gmail.com','Alice','contributor');
...
-- Dump completed on 2025-10-15 22:20:38
-- MySQL dump 10.13  Distrib 8.0.43, for Win64 (x86_64)
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-10-13 06:39:18',NULL),('diagnostics.include_raw','OFF','2025-10-13 06:39:18',NULL),('ps_thread_trx_info.max_length','65535','2025-10-13 06:39:18',NULL),('statement_performance_analyzer.limit','100','2025-10-13 06:39:18',NULL),('statement_performance_analyzer.view',NULL,'2025-10-13 06:39:18',NULL),('statement_truncate_len','64','2025-10-13 06:39:18',NULL);
...
-- Dump completed on 2025-10-15 22:20:39
